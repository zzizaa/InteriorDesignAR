...
extern const Il2CppDebuggerMetadataRegistration g_DebuggerMetadataRegistrationFacebook_Wit_Dictation;
...
const Il2CppCodeGenModule g_Facebook_Wit_Dictation_CodeGenModule = 
{
	...
	0,
	NULL,
	&g_DebuggerMetadataRegistrationFacebook_Wit_Dictation,
