...
extern const Il2CppDebuggerMetadataRegistration g_DebuggerMetadataRegistrationMeta_WitAi_TTS_Samples;
...
const Il2CppCodeGenModule g_Meta_WitAi_TTS_Samples_CodeGenModule = 
{
	...
	0,
	NULL,
	&g_DebuggerMetadataRegistrationMeta_WitAi_TTS_Samples,
